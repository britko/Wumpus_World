...
def CheckBreeze():
    ...
    if 'P' in maze[row+1][col] + maze[row-1][col] + maze[row][col-1] + maze[row][col+1]:
        explorer['breeze'] = True
    elif 'D' in maze[row+1][col] + maze[row-1][col] + maze[row][col-1] + maze[row][col+1]:
        explorer['breeze'] = True
    else:
...
def CheckGlitter():
    ...
    if 'G' in maze[row+1][col] + maze[row-1][col] + maze[row][col-1] + maze[row][col+1]:
...
def CheckBump():
    ...
    if 'B' in maze[row+1][col] + maze[row-1][col] + maze[row][col-1] + maze[row][col+1]:
        explorer['bump'] = True
    else:
        explorer['bump'] = False
    return explorer
...
def CheckStench():
    ...
    if 'W' in maze[row+1][col] + maze[row-1][col] + maze[row][col-1] + maze[row][col+1]:
